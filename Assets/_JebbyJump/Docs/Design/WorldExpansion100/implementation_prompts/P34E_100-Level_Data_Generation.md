# P34E — 100-Level Data Generation

**Phase objective:** Deterministic editor generator consumes doc 13 CSV → LevelConfig assets 011–100 (idempotent, dry-run, report). Update LevelBalanceAssetTests to 100/data-driven (doc 03 §6).
...
- **Files likely changed:** Scripts/Editor generator, Settings/Level/* assets, tests
...
- Assets match CSV; 100 unique ids; no dup; ranks ordered; NO balance claim
