# P34Q — World 09 — Stormfire Volcano Art Integration

**Phase objective:** Integrate the Stormfire Volcano art family (backgrounds/floor/6 platforms/volcanic_ember_spike/deco/UI) via idempotent wiring; validate colour identity + hazard behaviour-equivalence.
...
- **Files likely changed:** Art/Worlds/W09_StormfireVolcano/*, Scripts/Editor wiring, WorldW09 config, tests
