...
**Phase objective:** Opening + per-world + World-10 ending cards; first-view persistence (wardrobe-ack pattern), replay, skip/accessibility (doc 06).
...
- **Files likely changed:** Scripts/UI story presenter, persistence keys, tests
...
- Cards acknowledge once; replayable; skip works
