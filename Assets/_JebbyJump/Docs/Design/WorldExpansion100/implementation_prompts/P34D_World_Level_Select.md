# P34D — World Level Select

**Phase objective:** Restructure Level Select into 10 world cards → 10 level cards; preserve Continue; mobile/accessible nav (doc 11).
...
- **Files likely changed:** Scripts/UI LevelSelect*, MainMenu.unity, tests
...
- 10 worlds × 10 cards; touch targets; focus; locked/finale states
