# P34K — World 03 — Crystal Caves Art Integration

**Phase objective:** Integrate the Crystal Caves art family (backgrounds/floor/6 platforms/crystal_spike_cluster/deco/UI) via idempotent wiring; validate colour identity + hazard behaviour-equivalence.
...
- **Files likely changed:** Art/Worlds/W03_CrystalCaves/*, Scripts/Editor wiring, WorldW03 config, tests
