...
**Phase objective:** Reward model C: World Gem trophy (finale first-clear) + cosmetic on mastery. No currency; Stars not consumed (doc 07).
...
- **Files likely changed:** Scripts/Rewards+Wardrobe, persistence, tests
...
- Idempotent trophy; cosmetic unlock; Stars untouched
