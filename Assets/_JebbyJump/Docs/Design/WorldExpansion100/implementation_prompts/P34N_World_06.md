# P34N — World 06 — Candy Cloud Kingdom Art Integration

**Phase objective:** Integrate the Candy Cloud Kingdom art family (backgrounds/floor/6 platforms/candy_thorn/deco/UI) via idempotent wiring; validate colour identity + hazard behaviour-equivalence.
...
- **Files likely changed:** Art/Worlds/W06_CandyCloudKingdom/*, Scripts/Editor wiring, WorldW06 config, tests
