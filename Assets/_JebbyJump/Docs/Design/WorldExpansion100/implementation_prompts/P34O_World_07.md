# P34O — World 07 — Clockwork Heights Art Integration

**Phase objective:** Integrate the Clockwork Heights art family (backgrounds/floor/6 platforms/clockwork_spike/deco/UI) via idempotent wiring; validate colour identity + hazard behaviour-equivalence.
...
- **Files likely changed:** Art/Worlds/W07_ClockworkHeights/*, Scripts/Editor wiring, WorldW07 config, tests
