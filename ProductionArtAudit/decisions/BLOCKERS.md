# Blockers (numeric/spec values that must NOT be guessed)
...
| BLK-5 | Store screenshots capture | blocked on batches 003–006 being integrated first | integration order |
| BLK-6 | Wordmark store use | blocked on brand/legal review (originality/trademark) | human review |
| BLK-7 | Public-release use of ALL existing art | blocked on provenance/licence register (D3) — nothing records rights for the user-supplied sets | product owner |

Every other numeric value in the briefs/manifests is evidence-derived
(FILE-MEASURED, IMPORT-VERIFIED, code-derived, or EXTERNAL-SPEC-VERIFIED).
